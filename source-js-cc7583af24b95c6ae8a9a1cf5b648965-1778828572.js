...
$('.cooperate-parterner').before($('.block-article-customerCase'))
$('.panel-heading .pull-right').html('<a href="/customercase.html">查看更多</a>')

$('.as-box-right-btn').click(debounce(function(e)
{
    e.preventDefault();
    ...
    FingerprintJS.load()
      ...
      .then((result) => {
        ...
        $.post(createLink('targetstat', 'log'), {
...
;v.pageLayout = "object";;setTimeout(function(){$('#contactModal .modal-header .close').html('<span aria-hidden="true">×</span>')}, 500);
